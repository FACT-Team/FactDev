...
Le panneau initialement situé en bas à droite contient les informations de l'utilisateur\index{Utilisateur!Informations détaillées}, comme le montre ci-dessous la figure\ref{fig:dockUtilisateur}.

%\begin{figure}[H]
%	\centering
%	\includegraphics[width=7cm]{screens/dockUtilisateur.png}
