...
\begin{frame}{Quelques captures d'écrans\ldots}
	\begin{figure}[H]
		...
		\hspace{5px}
		\only<1>{
		\includegraphics[height=5.3cm]{images/img_results/main.png}~
		\caption{La fenêtre principale}
		}
		\only<2>{
		\includegraphics[height=5.5cm]{images/img_results/edit_quote.png}~
		\caption{Édition d'une facture}
		}
		\only<3>{		
		\vspace{80px}
		\includegraphics[height=7cm]{images/img_results/quote.png}~
		\caption{Facture générée}
		}
		\only<1-2>{
		\vspace{-13px}
		\includegraphics[height=1.5cm]{images/img_results/main.png}~
		}
		\only<1>{
		\includegraphics[height=1.5cm]{images/img_results/edit_quote_disable.png}~
		}
		\only<2>{
		\includegraphics[height=1.5cm]{images/img_results/edit_quote.png}~
		}
		\only<1-2>{
		\includegraphics[height=1.5cm]{images/img_results/quote_disable.png}
		}
