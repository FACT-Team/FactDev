...
\begin{frame}{FactDev : Un logiciel de Devis et Facturation}
	...
	\item Gestion de 
		\begin{itemize}
			\item Clients, projets associés
			\item Tarifs calculés
...
\begin{frame}{Scrum, une méthodologie de développement}
	\begin{itemize}
		...
		\begin{itemize}
			\item Scrum Master
			%% il guide les développeurs dans l’application de la méthode Scrum
			\item Product Owner
			%%Compréhension du projet et vérification du travail fourni
		\end{itemize}
		\item User Stories
		\begin{itemize}
			\item Priorité
			\item Fin d'une story
		\end{itemize}
		%% une User Story terminée quand
		%%Tests unitaires, intégrations et doc complète
		\item Organisation de mêlées
...
\end{frame}
\subsection{Intégration\ldots}
% Pull Requests	
% Branching flow
\begin{frame}
\end{frame}
\subsection{\ldots Continue}
\begin{frame}
% Travis	
% Couverture de code
% Build, 
